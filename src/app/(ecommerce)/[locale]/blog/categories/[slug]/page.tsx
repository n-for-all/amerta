...
const BlogCategoryPage: React.FC<{ searchParams: Promise<SearchParams>; params: Promise<{ locale: string; slug: string }> }> = async ({ searchParams, params }) => {
  ...
  return (
    <div className="container">
      ...
      <Pagination currentPage={parseInt(page as string, 10)} totalPages={totalPages} baseUrl={getURL(`/blog/categories/${slug}/`, locale)} locale={locale} />
    </div>
  );
};
