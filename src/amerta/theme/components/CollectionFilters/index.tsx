...
export function CollectionFilters({ totalProducts, currentProductCount, brands, collections, options }: CollectionFiltersProps) {
      ...
      <div className="mx-auto md:ml-auto md:mr-0 rtl:md:ml-0 rtl:md:mr-auto">
        ...
        <div className="hidden sm:flex sm:items-baseline sm:space-x-1">
          ...
          {collections && collections.length > 0 && (
            <FilterDropdown label={__("Collection")} count={searchParams.getAll("collection").length}>
