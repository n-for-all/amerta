  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between w-24 mt-2 sm:w-28">
        <button
          disabled={loading}
          className="flex items-center justify-center w-8 h-8 bg-white border rounded-full border-zinc-950/15 hover:border-zinc-950/20 focus:outline-none disabled:cursor-default dark:border-neutral-500 dark:bg-neutral-900 dark:hover:border-neutral-400"
          type="button"
          onClick={() => onChange(-1)}
        >
...
export default function AddToCartForm({ product, options, noDefaults, compact, icon, buttonVariant = "default", buttonClassName, className, onVariantChange }: AddToCartFormProps) {
