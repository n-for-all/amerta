<div align="center">
  <a href="https://amerta.io" target="_blank">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://storage.googleapis.com/ajaxy/amerta/amerta-logo-dark.svg">
      <img alt="Amerta Logo" src="https://storage.googleapis.com/ajaxy/amerta/amerta-logo.svg" width="280"/>
    </picture>
  </a>
  ...
  <strong>
    A production-ready E-commerce starter built with Next.js 16 (App Router) and Payload CMS 3+.
  </strong>
  ...
  <p>
    Amerta combines a high-performance Next.js storefront with a powerful, headless Payload CMS backend. 
    It features a custom authentication system, isolated admin panel, and a modular architecture designed for scale.
  </p>
  ...
  <p>
    ...
    ·
    <a href="https://github.com/n-for-all/amerta/discussions">Request Feature</a>
  </p>
</div>
...
<p align="center">
  <img src="https://storage.googleapis.com/ajaxy/amerta/amerta-screenshot.jpg" alt="Amerta Screenshot" width="100%" style="border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);" />
</p>
